...
static const char* PIPELINE_TEMPLATE =
  "autoaudiosrc ! audioconvert ! webrtcdsp echo-cancel=false high-pass-filter=false voice-detection=true voice-detection-likelihood=high noise-suppression-level=very-high voice-detection-frame-size-ms=30 "
